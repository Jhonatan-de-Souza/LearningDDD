...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(DomainDrivenDesign.MVC.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(DomainDrivenDesign.MVC.App_Start.NinjectWebCommon), "Stop")]

namespace DomainDrivenDesign.MVC.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            //For generic classes you must use TypeOf
            kernel.Bind(typeof(IAppServiceBase<>)).To(typeof(IAppServiceBase<>));
            //For non generic classes you dont need to 
